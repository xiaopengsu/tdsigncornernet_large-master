...
'''
COCO_CATEGORIES = [
    #{"color": [220, 20, 60], "isthing": 1, "id": 1, "name": "Traffic_Sign_(Back)"},
    #{"color": [119, 11, 32], "isthing": 1, "id": 2, "name": "Traffic_Sign_(Front)"},
    {"color": [220, 20, 60], "isthing": 1, "id": 1, "name": "B"},
    {"color": [119, 11, 32], "isthing": 1, "id": 2, "name": "F"},
]
'''
...
#COCO_CATEGORIES = [
#    {"color": [220, 20, 60], "isthing": 1, "id": 1, "name": "lanecorner"}, #################lanecorner
#]
...
def _get_coco_instances_meta():
    ...
    assert len(thing_ids) == 6, len(thing_ids)    #############   lanecorner 1

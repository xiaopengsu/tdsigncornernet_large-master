...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions):
        ...
        return self.output,self.newboxes,self.newlabels
    ...
    def overlay_instances(
        ...
        *,
        ...
        for i in range(0,len(labels)):
             la=labels[i].split(' ')[0]
             if la == 'traffic3' or la == 'traffic4' or la == 'traffic3-back' or la == 'traffic4-back' or la == 'circle' or la == 'circle-back':
                 new_boxes.append(boxes[i])
                 new_labels.append(labels[i])
        boxes = new_boxes                ###########
        labels = new_labels              ###########
        num_instances = len(boxes)
        self.newboxes = new_boxes
        ...
        for i in range(0,len(labels)):
             new_boxes.append(boxes[i])
             new_labels.append('lanecorner')
        boxes = new_boxes                ###########
        labels = new_labels              ###########
        print('lllllllllllllllllllllllllllllllllllllllllllllllllll',labels)
        num_instances = len(boxes)
        self.newboxes = new_boxes
        self.newlabels = new_labels
        '''
    ...
    def draw_text(
        ...
        *,
        ...
        self.output.ax.text(
            ...
            family="sans-serif",
            bbox={"facecolor": "black", "alpha": 0.1, "pad": 0.7, "edgecolor": "none"},        #############alpha": 0.8
